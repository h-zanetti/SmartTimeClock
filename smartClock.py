...
while (tries < 3):
        ...
        ID = input("ID: ")
        if int(ID) == dataBase[username]["ID"]:
                while(True):
                        ...
                        if lower == "add employee":
                                ...
                                getTotalHours(username)
                        elif lower == "my paycheck":
                                getPaycheck(username, 10)
                                ...
                                if name == "all":
                                        for employee in dataBase:
                                                print("%s: %s" % dataBase[employee]["Name"], dataBase[employee]["TotalHours"])
                                else:
                                ...
                                if name == "all":
                                        for employee in dataBase:
                                                print("%s: $" % dataBase[employee]["Name"], dataBase[employee]["Paycheck"])
                                else:
